...
我本来写的相对路径 './src' 速度447ms，换成path.resolve(__dirname,'src') 速度暴涨到1220ms？？？
 ...
 近年来，由公益慈善捐款引发的社会热点问题层出不穷，从郭美美、发票门、小数点风波到罗一笑，各种诈捐事件、公款私用、钱款去向不明等问题侵蚀着公众对公益慈善机构的信任。“中国社会并不缺少善心，缺少的是对公益组织的信心。”这是国际著名咨询机构麦肯锡公司对中国公益事业作出的评价。
       2017年3月，光大银行区块链公益捐款项目由科技创新实验室成功孵化。该项目源于科技创意金点子“基于区块链的公益捐款系统”，经科技创新工作小组会议评审立项后，科技创新实验室通过对创意的深入挖掘和新技术预研，成功完成金点子的孵化试点。
       
   光大银行基于区块链技术特点，以重建慈善公信力为使命，打造了一个交易透明、不可篡改、全程可追溯的慈善捐款平台。通过分布式账本和节点共识技术，使得捐款信息公开、捐款费用可追溯、账务信息不可篡改，并实现了捐款者隐私的保护。通过智能合约技术，让善款的使用规则在公益捐款开始前就固化到区块链当中，实现了善款的专款专用和全流程可追溯。
      对于捐款者，区块链技术可以使捐款费用的流转、使用情况透明可控，降低捐款者的顾虑；对于公益机构，区块链技术可以增加整个公益活动的可信度；对于银行，可以将公众的爱心安全、可靠的传递给慈善机构，提升了自身的社会形象和公信力。

光大区块链公益捐款项目
以科技创新助力公益事业的健康发展
       光大区块链慈善捐款平台包括供个人捐款和资金追溯的客户端、供公益机构进行合约维护、资金查询等操作的后台以及监控区块交易、追溯捐款凭证的浏览器。
       该项目充分利用区块链技术透明、安全、可追溯的特点，以分布式账本和智能合约为核心功能，确保慈善机构的账务透明和专款专用。使用区块链的分布式账本对慈善业务进行记账，使客户每一次爱心付出都记录在册，不可被篡改，并可对全社会公开。使用智能合约对捐款进行编程，从技术角度实现善款的专款专用，提升慈善机构的社会公信力。
       通过光大区块链公益捐款项目的孵化，可实现慈善项目环节中真正的账务透明、专款专用、账务可追溯，有效解决慈善事业中公信力不足的顽疾。在提升银行公信力和技术可信力的同时，将公众的爱心安全可靠的传递给慈善机构，对慈善基金来源和使用进行更加有效的监管，提升了公益捐款透明度，有助于推动慈善公益事业的健康发展。      
